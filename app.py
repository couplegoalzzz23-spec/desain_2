...
# =====================================
# 2. CSS — GABUNGAN MILITARY STYLE + EDGE-TO-EDGE BANNER
# =====================================
st.markdown("""
    <style>
...
# =====================================
# 3. ENGINE CAROUSEL (SWIPER BANNER)
# =====================================
...
# =====================================
# 4. DATABASE LANUD, ADM1, & KONSTANTA
# =====================================
LANUD_MAP = {
...
# =====================================
# 5. ENGINE PENGAMBIL DATA METAR/TAF (FALLBACK)
# =====================================
...
# =====================================
# 6. ENGINE PDF FPDF (QAM GENERATOR)
# =====================================
class QAM_PDF(FPDF):
    def header(self):
